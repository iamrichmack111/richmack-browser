...
echo "[1/5] Richmack Browser OS v0.5.4"
...
if printf '%s' "$HEALTH" | grep -q '"suite":"0.5.4"'; then
...
echo "      Fresh v0.5.4 profiles request Chromium's 'pin new extensions' preference."
